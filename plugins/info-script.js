...
let res = await fetch('https://api.github.com/repos/EnzoVaselevich/DiablaBot-MD-oficial)
...
await conn.sendUrl(m.chat, git, m, { externalAdReply: { mediaType: 1, renderLargerThumbnail: true, thumbnail: imagen2, thumbnailUrl: imagen1, title: '\t\t\t\t\t\t᭡͡ᩬ🍧✩̣̣̣̣̣ͯ𝐃𝐢𝐚𝐛𝐥𝐚𝐁𝐨𝐭-𝐌𝐃᭡͡ᩬ🍧✩̣̣̣̣̣ͯ', }})
